 ...
 * @return
 */
size_t lenLifeCycleTopic(const char *id, const char *name) {
    size_t res = 0;
 ...
 * @param name  = name of the lifecycle topic (ON, OFF, KEEP)
 */
void genLifeCycleTopic(char *topic, const char *id, const char *name) {
 ...
 * @return
 */
size_t lenThingTopic(const char *id, const char *name) {
    size_t res = 0;
    res = strlen(MQTT_TOPIC_THING_HEADER) +
          strlen(id) +
 ...
 */
void genThingTopic(char *topic, const char *id, const char *name) {
    sprintf(topic, "%s/%s/%s/%s", MQTT_TOPIC_THING_HEADER, id,
 ...
 * @return
 */
size_t lenGroupTopic(const char *grp, const char *name) {
    size_t res = 0;
 ...
 * @param name - string name of the topic
 */
void genGroupTopic(char *topic, const char *grp, const char *name) {
 ...
 * @return
 */
size_t lenThingUpdate(const char *id) {
    size_t res = 0;
    res = strlen(MQTT_TOPIC_THING_HEADER) +
          strlen(id) +
 ...
 */
void getThingUpdate(char *topic, const char *id) {
    sprintf(topic, "%s/%s/%s/%s", MQTT_TOPIC_THING_HEADER, id,
 ...
 * @return
 */
size_t lenThingGet(const char *id) {
    size_t res = 0;
    res = strlen(MQTT_TOPIC_THING_HEADER) +
          strlen(id) +
          strlen(MQTT_STATE_TOPIC) +
 ...
 * @param id - Id of thing
 */
void getThingGet(char *topic, const char *id) {
    sprintf(topic, "%s/%s/%s/%s", MQTT_TOPIC_THING_HEADER, id,
 ...
 * @return
 */
size_t lenThingSet(const char *id) {
    size_t res = 0;
    res = strlen(MQTT_TOPIC_THING_HEADER) +
          strlen(id) +
          strlen(MQTT_STATE_TOPIC) +
 ...
 * @param id - Id of thing
 */
void getThingSet(char *topic, const char *id) {
    sprintf(topic, "%s/%s/%s/%s", MQTT_TOPIC_THING_HEADER, id,
