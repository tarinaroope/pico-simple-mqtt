...
if(NOT WIFI_SSID_SET)
    set(WIFI_SSID_SET "TuulispaaIOT") # Put your own WiFi SSID
    message("WiFi SSID set: ${WIFI_SSID_SET}")
endif()

if(NOT WIFI_PASSWORD_SET)
    set(WIFI_PASSWORD_SET "TarkkaPirkko78") # Put your own WiFi Password
...
if(NOT MQTT_USER_SET)
    set(MQTT_USER_SET "tuulispaa_mqtt") # Put your own MQTT USER
    message("MQTT USER set: *******")
endif()

if(NOT MQTT_PASSWD_SET)
    set(MQTT_PASSWD_SET "TarkkaPirkko78") # Put your own MQTT password
    message("MQTT Password set: *******")
endif()

if(NOT MQTT_HOST_SET)
    set(MQTT_HOST_SET "192.168.12.82") # Put your own MQTT HOST
    message("MQTT HOST set: *******")
endif()

if(NOT MQTT_PORT_SET)
    set(MQTT_PORT_SET 1883) # Put your own MQTT PORT
